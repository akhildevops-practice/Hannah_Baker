...
export class AuditsController {
  ...
  async isLoggedinUsercreateAuditPlanByAuditTypeId(@Req() req, @Param('id') id) {
    return this.auditPlanService.isLoggedinUsercreateAuditPlanByAuditTypeId(req.user,id);
  }


  @UseGuards(AuthenticationGuard)
  @Get('isLoggedinUsercreateAuditScheduleByAuditTypeId/:id')
  async isLoggedinUsercreateAuditScheduleByAuditTypeId(@Req() req, @Param('id') id) {
    return this.auditPlanService.isLoggedinUsercreateAuditScheduleByAuditTypeId(req.user,id);
  }
  ...
  async updateDataofDropDown(@Req() req, @Body() data, @Param('status') status) {
