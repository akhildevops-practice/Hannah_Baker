...
export class OrganisationController {
  ...
  async getFreshWorksData(
    ...
    return await this.organizationService.getFreshWorksData(
      {
        // orgName,
        ticketId,
        description,
  ...
  @UseGuards(AuthenticationGuard)
  @Get('getTicketMessages/:id')
  async getTicketMessages(@Param('id') id, @Req() req) {
    return await this.organizationService.getTicketMessages(id);
  }
