...
export class GlobalsearchController {
  ...
  findAll(@Query() query: DashboardFilter, @Req() req: any) {
    console.log('query in finALl controller', query);
  ...
  @UseGuards(AuthenticationGuard)
  @Get('/getAspImpSearchResultWithFilter')
  getAspImpSearchResultWithFilter(@Query() query: any, @Req() req: any) {
    return this.globalSearchService.fetchAspectImpact(
      query?.searchQuery,
      query?.organizationId,
      query,
      "",
