...
export class KpiDefinitionController {
  ...
  async getSelectedKpiById(@Param('id') id) {
    const randomNumber = uuid();
    this.logger.log(
  ...
  async getSelectedKpi(@Param('id') id) {
    const randomNumber = uuid();
    this.logger.log(
  ...
  async createOwners(@Req() req, @Body() data) {
    ...
    return this.kpidefinition.createOwners(req.user?.id, data, randomNumber);
  }
  ...
  async updateOwners(@Req() req, @Body() data, @Param('id') id) {
    ...
    return this.kpidefinition.updateOwners(
      req.user?.id,
      data,
      randomNumber,
      id,
  ...
  async getObjOwners(@Req() req, @Query() query) {
    ...
    return this.kpidefinition.getObjOwners(req.user?.id, query, randomNumber);
  }
  @UseGuards(AuthenticationGuard)
