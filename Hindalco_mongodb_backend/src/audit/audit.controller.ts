...
export class AuditController {
  ...
  @UseGuards(AuthenticationGuard)
  @Get('getNcDataByAuditId/:id')
  getNcDataByAuditId(@Req() req, @Param('id') id) {
    return this.auditService.getNcDataByAuditId(req.user, id);
  }
  ...
  findOneForPdf(@Param('id') id: string) {
    return this.auditService.findOneForPdf(id);
  }
