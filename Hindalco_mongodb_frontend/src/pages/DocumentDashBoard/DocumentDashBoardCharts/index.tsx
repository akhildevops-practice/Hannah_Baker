...
import { Chart as ChartJS, Title, Tooltip as ChartTooltip } from "chart.js";
...
import { ArrowsAltOutlined, FileExcelTwoTone } from "@ant-design/icons";
...
const DocumentDashBoardCharts = ({
  ...
  const [isModalOpenForDeptChart, setIsModalOpenForDeptChart] = useState(false);

  const showModalForDept = () => {
    setIsModalOpenForDept(true);
    setIsModalOpenForDeptChart(true);
  };

  const handleOkForDept = () => {
    setIsModalOpenForDept(false);
    setIsModalOpenForDeptChart(false);
  };
  ...
  return (
    <div
      style={{
        ...
        // backgroundColor: "red",
        marginTop: "3px",
        marginLeft: matches ? "45px" : "10px",
        marginRight: matches ? "45px" : "10px",
      }}
    >
      <Paper
        elevation={0}
        style={{
          marginTop: "15px",
          // width: activeTab > 3 ? "650px" : "450px ",
          width: matches ? (activeTab > 3 ? "650px" : "450px") : "90%",
          height: "330px",
          backgroundColor: "#fff",
          borderRadius: "12px",
      ...
      >
        <div
          style={{
            ...
            padding: "0px 10px",
            // width: activeTab > 3 ? "640px" : "440px",
            width: matches ? (activeTab > 3 ? "640px" : "440px") : "86%",
            height: "280px",
          }}
        >
          <ByDepartmentChart
            ...
            name={name}
            activeTab={activeTab}
            isModalOpenForDeptChart={isModalOpenForDeptChart}
          />
          {matches ? <ArrowsAltOutlined onClick={showModalForDept} /> : null}
        </div>
      </Paper>
      ...
      >
        <div style={{ width: "95vw", height: "73vh", paddingBottom: "30px" }}>
          <ByDepartmentChart
            deptData={deptData}
            setFilterQuery={setFilterQuery}
            entity={entity}
      ...
      {activeTab > 3 && (
        ...
        >
          ...
          >
            ...
            />
            {matches ? (
              <ArrowsAltOutlined onClick={showModalForStatus} />
            ) : null}
      ...
      >
        <div style={{ width: "85vw", height: "63vh", paddingBottom: "30px" }}>
          <ByStatusChart
            statusData={statusData}
            setFilterQuery={setFilterQuery}
            filterQuery={filterQuery}
      ...
      >
        ...
        >
          <ByTypeChart
            ...
            activeTab={activeTab}
          />
          {matches ? <ArrowsAltOutlined onClick={showModalForType} /> : null}
      ...
      >
        ...
        >
          <BySystemChart
            ...
            activeTab={activeTab}
          />
          {matches ? <ArrowsAltOutlined onClick={showModalForSystem} /> : null}
