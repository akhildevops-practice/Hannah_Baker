...
import { CheckCircleOutlined, SyncOutlined } from "@material-ui/icons";
            ...
            {tableData?.map((record) => {
              ...
              return (
                ...
                >
                  ...
                  <td className={classes.td}>{record?.mrm_totalMrmPlans || 0}</td>
                  <td className={classes.td}>{record?.mrm_totalMrmSchedule || 0}</td>
