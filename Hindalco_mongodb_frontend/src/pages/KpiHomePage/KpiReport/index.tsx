...
import { DayHeader } from "@fullcalendar/react";
          ...
          <Grid container alignItems="flex-end" justifyContent="space-between">
            ...
            >
              <TextField
                ...
                name={"search"}
                value={searchValue}
                placeholder={"Search Report(Kpi name, UOM, Report name)"}
            ...
            >
              {/* <TextField
                ...
                style={{
                  ...
                  color: "black",
                  fontWeight: "bold", // Adjust fontWeight here
                  fontSize: "20px", // Adjust fontSize here
                }}
                InputProps={{
                  style: {
                    fontWeight: "bold",
                ...
                renderInput={(params: any) => (
                  <TextField
                    ...
                    InputLabelProps={{
                      style: {
                        fontWeight: "bold", // Adjust fontWeight here
                        fontSize: "1rem", // Adjust fontSize here
                        marginBottom: "5px", // Add extra styles if needed
                      },
                    }}
                  />
                )}
