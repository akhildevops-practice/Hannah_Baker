...
const MRM = () => {
  ...
  //   getDataTableMeetings();
  // }, [pageLimit, page, isMeetingFilterOwner]);
    ...
    try {
      ...
      if (res.status === 200 || res.status === 201) {
        ...
        for (let i = 0; i < data?.length; i++) {
          ...
          let actionPoints = value?.value.meetingData;
                ...
                >
                  <Tooltip title="Download Pdf" placement="bottom">
                    <div ref={refForMeeting9}>
                      <PictureAsPdfOutlinedIcon style={iconStyle} />
                    </div>
                  </Tooltip>
                </IconButton>
              )}
  ...
  // console.log("isMR", isMR, selectedUnit);
        ...
        <body>
         ...
         <tr>
           <td style="width: 100px;">
             ...
             }" alt="Hindalco Logo" width="100px" height="100px" />
           </td>
...
`
  ...
  return (
    <>
      ...
      >
        {matches ? (
          <div className={classes.tabWrapper} style={{}}>
            <div
              ...
              <>
                <Grid item xs={12} md={6}>
                  ...
                  >
                    ...
                    >
                      <div style={{ width: "100%" }} ref={refForMRMSchedule2}>
                        <Autocomplete
                          disablePortal
                          id="combo-box-demo"
                ...
                <Input
                  ...
                  suffix={
                    <Button
                      ...
                      icon={<SearchIcon />} // Use SearchIcon as the suffix button
      ...
      >
        ...
        >
          ...
          <FormControl variant="outlined" style={{ flex: 1, width: "300px" }}>
            <div style={{ width: "100%" }}>
              <Autocomplete
                disablePortal
                id="combo-box-demo"
                ...
                {dataSource?.map((data: any) => (
                  ...
                  >
                    ...
                    <p>
                      ...
                      <div>
                        {data?.value?.date &&
                          data?.value?.date.map((dateObj: any, index: any) => {
                            const { date, from, to } = dateObj;
                    ...
                    >
                      <div style={{ width: "100%" }}>
                        {/* <Autocomplete
                          disablePortal
                          id="combo-box-demo"
                          options={[allDeptOption, ...actionPointDeptOptions]}
                ...
                >
                  {actionPointDataSource?.map((data: any) => (
                    ...
                    >
                      ...
                      <p>
                        MRM Meeting Name : {data.additionalInfo?.meetingName}
                      </p>
                      <p>
                        Responsible Person :
                        <div>
                  ...
                  {meetingsDataApi?.map((data, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p>
                          Schedule Name: {data?.meetingSchedule?.meetingName}
                        </p>
                        <p>
                          Meeting Date & Time:
                          <div style={{ display: "flex", gap: "10px" }}>
                            ...
                            >
                              {data?.actionItem?.map((datas: any) => (
                                <div>
                                  <p
                                    onClick={() => {
                                      handlerActionEditOpen(datas, "ReadOnly");
                                    }}
                                    style={{
                                      textDecorationLine: "underline",
                                      cursor: "pointer",
      ...
      >
        <DialogContent>
          <DialogContentText>
            You are about to create Ad-hoc Meeting schedule without MRM Plan. Do
      ...
      {matches ? (
        <div style={{ position: "fixed", top: "80px", right: "120px" }}>
