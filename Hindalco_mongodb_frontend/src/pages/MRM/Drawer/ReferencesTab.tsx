...
//antd
import { Modal, Table, Button, Form, Input, Popconfirm } from "antd";
...
const ReferencesTab = ({ drawer, mrmEditOptions }: Props) => {
  ...
  //console.log("drawer in references tab", drawer);
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (drawer?.mode === "edit") {
      //console.log("inside edit useffect");
      getRefsForDocument();
    }
  }, [drawer?.mode]);
  ...
  return (
    <div className={classes.modalWrapper}>
      ...
      <TextField
        ...
        value={searchValue}
        disabled={mrmEditOptions === "ReadOnly" ? true : false}
