...
const TabsWrapper = ({
  ...
  useEffect(() => {
    console.log("drawerDataState in tabs wrapper", drawerDataState);
    console.log(
      "selelcted approver, selected revuewer-==>",
      selectedApproverFormData,
      selectedReviewerFormData
    );
    console.log("formdata in tabs wrapper", formData);
          ...
          >
            ...
            <Space style={{ display: "flex", justifyContent: "flex-end" }}>
              ...
              >
                ...
                <ExpandMoreOutlinedIcon
                  style={{
                    fill: `${drawerDataState?.items?.length === 0 ? "gray" : "#0e497a"}`,
                  }}
                />
              </Button>
              <Menu
