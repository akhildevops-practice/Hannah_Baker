...
import { auditeeSectionData, ncsForm, observationData, tab } from "recoil/atom";
...
import KraDrawer from "pages/Objectives/Objective/KraRegister/ObjectiveKra/KraDrawer";
...
`;
  ...
  const handleFilterList = (value: any) => {
    let filteredAuditList: any = filterList?.audit?.filter((item: any) =>
  ...
  let isLocAdmin = checkRole("LOCATION-ADMIN");
  ...
  const getTableData = (locationId: string = "", type: string = "") => {
    var loc: any = locationId === "" ? searchValue.location : locationId;
