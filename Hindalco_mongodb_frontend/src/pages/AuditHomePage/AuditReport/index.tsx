...
import AuditReportWrapper from "containers/AuditReportWrapper";
...
import "./styles.css";
import ReusableCalendar from "components/ReusableCalendar/Calendar";
...
const AuditReport = ({
  ...
  const handleDiscard = () => {
    ...
    fetchAuditReportTableData(
      ...
      .then((res: any) => {
        ...
        let data = parseData(res?.data?.audits);
  ...
  const getAuditData = (id: string) => {
    getAuditForPdf(id).then(async (response: any) => {
      let allFindings = await axios.get(
      ...
      //console.log("TEMPLATE ", fillTemplate);
                  ...
                  {/* <Grid item style={{ marginRight: "3px" }}>
                    <Button
                      style={{
                        ...
                        color: selectedOption === "My Loc" ? "white" : "black",
                        // borderRadius: "10px",
                      }}
                  ...
                  <Grid item style={{ marginRight: "3px" }}>
                    <Button
                      style={{
                        ...
                        color:
                          selectedOption === "My Audits" ? "white" : "black",
                        // borderRadius: "3px",
                      }}
                      onClick={() => handleButtonClick("My Audits")}
                    >
                      <AuditOutlined style={{ marginRight: "2px" }} />
                      My Audits
                    </Button>
                  </Grid>
                </div>
