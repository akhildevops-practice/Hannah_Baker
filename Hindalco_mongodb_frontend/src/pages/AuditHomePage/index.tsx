...
import { FloatButton, Popover, Tooltip, Tour } from "antd";
...
import { ReactComponent as CalendarSvg } from "assets/icons/CustomCalendarIcon.svg";
...
import calenderview from "assets/dashboardIcons/calender-view.png";
import boardView from "assets/dashboardIcons/board-view.png";
import listview from "assets/dashboardIcons/list-view.png";
...
const AuditHomePage = () => {
  ...
  return (
    <>
      ...
      {matches ? (
        <div ref={refForSettings1}>
          <ModuleNavigation
            tabs={matches ? tabs : mobileTabs}
            activeTab={acitveTab}
            setActiveTab={setActiveTab}
            currentModuleName={currentModuleName}
            setCurrentModuleName={setCurrentModuleName}
            createHandler={
              acitveTab === "4" || acitveTab === "5" || acitveTab === "1"
                ? false
                : acitveTab !== "4" && acitveTab === "2" && view
                ? false
                : createHandler
            }
            ...
            refelemetForSettings1={refForSettings1}
          />
        </div>
      ) : (
