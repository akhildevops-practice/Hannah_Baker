...
import { Button, Divider, Modal, Popover, Tour, TourProps } from "antd";
...
function AuditScheduleFormStepper({
  ...
  // useEffect(() => {
  //   console.log("checkaudit5 isSchedulein draft", isScheduleInDraft);
  // }, [isScheduleInDraft]);

  // useEffect(() => {
  //   console.log("checkaudit4 teamLeadId useeffect[teamLeadId]", teamLeadId);
  // }, [teamLeadId]);
          ...
          {isLoading ? (
            ...
            <>
              ...
              >
                ...
                >
                  {isEdit &&
                    ...
                    userDetails?.id !== teamLeadId && (
                      ...
                      >
                        This Schedule is pending with Team Lead, Team Lead Only
                        Can Finalise Auditors & Checklist!
                      </Typography>
                    )}
                </div>
                <AuditScheduleForm1
                ...
                >
                  Team Lead is Available for this Finalised Date, Auditors and
                  Audit Checklist will be further added by Team Lead. Please
                  Continue adding rest of the details and Save the Schedule As
                  Draft.
                </Modal>
                ...
                >
                  {isEdit && auditScheduleData?.planNumber === "No plan" && (
                    <Button
                      size="middle"
                      type="primary"
                      onClick={() => {
