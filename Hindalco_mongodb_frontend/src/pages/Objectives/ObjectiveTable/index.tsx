...
import CommentsModal from "../Objective/KraRegister/CommentsModal";
import ReviewModal from "../Objective/KraRegister/ReviewModal";
import { ReactComponent as ExpandIcon } from "../../../assets/icons/row-expand.svg";
import KraDrawer from "../Objective/KraRegister/ObjectiveKra/KraDrawer";
...
const ObjectiveTable = () => {
  ...
  const handleTableSearch = () => {
    setPage(1);
    setRowsPerPage(10);
    let url = `api/objective/searchObjectMaster?text=${searchQuery.searchQuery}&ObjectivePeriod=${currentYear}`;
    fetchObjectives(url);
  };
  ...
  const handleChangePageNew = (page: any, pageSize: any = rowsPerPage) => {
    ...
    let changeUrl = formatDashboardQuery(`/api/objective/getAllObjectMaster`, {
      page: page,
      limit: rowsPerPage,
      locationId: selectedLocation.id,
      year: currentYear,
