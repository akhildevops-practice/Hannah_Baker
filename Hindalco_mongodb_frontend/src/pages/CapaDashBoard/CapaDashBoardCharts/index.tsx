...
const CapaDashBoardCharts = ({
  ...
  return (
    <>
      {/* {allOption === "All" || allDepartmentOption === "All" ? null : (
        <Grid
          container
          spacing={2}
        ...
        >
          <Grid item xs={12} sm={6} md={5}>
            <Paper className={classes.card}>
              <div className={classes.number}>{capaChartData?.mydeptcount}</div>
              <Typography className={classes.label}>My Dept</Typography>
            </Paper>
          </Grid>
          <Grid item xs={12} sm={6} md={5}>
            <Paper className={classes.card}>
              <div className={classes.number} style={{ color: "#16A34A" }}>
                {capaChartData?.myloccount}
              </div>
      ...
      >
        ...
        {allOption === "All" ? null : (
          <div style={{ width: basicOrAdvance === "Advanced" ? "47%" : "96%" }}>
        ...
        {allOption === "All" ? (
          <Paper
            ...
            style={{
              ...
              border: "1px solid #d7cdc1",
              borderRadius: "5px",
              width: basicOrAdvance === "Advanced" ? "47%" : "96%",
              height: "380px",
              boxShadow: "0 0 6px 0 rgba(0, 0, 0, 0.25)",
            }}
          >
