...
import { Edit, Delete, CheckBox, InfoOutlined } from "@material-ui/icons";
...
function TangibleTable(props: any) {
  ...
  const handleEditChange = async (e: any, i: number) => {
    ...
    let cipData = JSON.parse(JSON.stringify(props.data));
    ...
    props.setData((prev: any) => {
      ...
      let noDuplicates = _.uniqBy(cipData, "benefitArea");
