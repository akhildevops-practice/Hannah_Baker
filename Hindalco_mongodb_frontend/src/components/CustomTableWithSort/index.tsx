                  ...
                  {fields.map((item: any, index: number) => (
                    <TableCell className={classes.tableCell} key={item}>
                      ...
                      { isAuditReport && index === 0 ? (
                        ...
                        >
                          <PictureAsPdfOutlinedIcon  style={{ color: "rgba(0, 0, 0, 0.6)", width : '20px' , height : '18px', cursor : 'pointer' }}/>
                        </div>
                      ) : null}
                      { isAuditChecklistReport && index === 0 ? (
                        ...
                        >
                        <AssessmentOutlinedIcon  style={{ color: "rgba(0, 0, 0, 0.6)", width : '20px' , height : '18px', cursor : 'pointer' }}/>
                      </div>
                      ) : null} 
                      {val[item]}
                      </div>
