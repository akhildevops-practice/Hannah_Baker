...
const HiraReferenceResultModuleTabs = ({
  documentsTableData = [],
  clausesTableData = [],
  ncTableData = [],
  hiraTableData = [],
  ...
  }, [moduleNames, searchValue, documentsTableData, clausesTableData, hiraTableData]);
  useEffect(() => {
    // console.log("doc data in refmoduletab useeffect[searchvalue]-->", documentsTableData);
  }, [searchValue]);

  useEffect(()=>{console.log("capa data in module tabs", capaData);
  },[capaData])
...
export default HiraReferenceResultModuleTabs;
