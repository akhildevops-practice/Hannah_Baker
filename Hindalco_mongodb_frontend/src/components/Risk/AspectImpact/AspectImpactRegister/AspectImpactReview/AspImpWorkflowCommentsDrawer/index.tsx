...
const AspImpWorkflowCommentsDrawer = ({
  commentDrawer,
  setCommentDrawer,
  ...
  useEffect(() => {
    console.log("checkrisk in AspImpWorkflowCommentsDrawer", commentDrawer);
  ...
  return (
    <Drawer
      title={"Aspect Impact Workflow Comments History"}
...
export default AspImpWorkflowCommentsDrawer;
