    ...
    <>
      ...
      >
        <Row gutter={[16, 16]}>
          <Col span={24}>
            <Form.Item
              label="Control Measure Title: "
              name="title"
              tooltip="This is a required field"
              rules={[
                {
                  required: true,
                  message: "Please Input Your Control Measure Title!",
                },
              ]}
            >
              <Input placeholder="Enter Control Measure Title" size="large" />
            </Form.Item>
          </Col>
        </Row>
        <Row gutter={[16, 16]}>
          <Col span={12}>
            <Form.Item label="Control Measure Stage: " name="stage">
              <Select
        ...
        <Row gutter={[16, 16]}>
          <Col span={24}>
            <Form.Item label="Control Measures: ">
