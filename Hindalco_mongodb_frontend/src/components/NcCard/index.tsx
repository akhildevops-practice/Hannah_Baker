...
export default function NcCard({
  ...
  const fetchAllClauses = () => {
    ...
    const selectedClauses = auditInfo.auditedClauses.map((value:any)=>value.item.id)
  ...
  const handleChange = (e: any) => {
    let dataCopy = JSON.parse(JSON.stringify(ncData));
                  ...
                  <Grid item sm={12} md={8} className={classes.formBox}>
                    ...
                    ref={refForReportForm18}
                      disabled={
                        ncData[checkListIndex].sections[sectionIndex].fieldset[
                          questionIndex
                        ].nc.type === "Observation$&*[]jhabsjdbjhabdjasdbas"
                          ? true
                      ...
                      onChange={(e: any, value: any) => {
                        handleClauseChange(sectionIndex, questionIndex, value);
                      }}
